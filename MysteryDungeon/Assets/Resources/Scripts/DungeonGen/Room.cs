...
public class Room
{
    ...
    //return a Vector3 position of a random tile in the room
    public Vector3 RandomTile()
    {
        int maxXPos = xPos + roomWidth;
        int maxYPos = yPos + roomHeight;

        int randX = Random.Range(xPos, maxXPos);
        int randY = Random.Range(yPos, maxYPos);
